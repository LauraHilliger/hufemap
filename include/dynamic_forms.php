...
function display_form ($form_id, $mode,  $prams, $section) {
	...
	$sql = "SELECT t2.field_label AS FLABEL, t1.field_id AS ID, t2.field_comment AS FCOMMENT, t1.* FROM form_fields AS t1, form_field_translations AS t2 WHERE t1.field_id=t2.field_id AND lang='".$_SESSION['MDS_LANG']."' AND section='$section' AND form_id='$form_id' $where_sql order by field_sort  ";
	//echo $sql;
	$result = mysql_query ($sql) or die (mysql_error());
